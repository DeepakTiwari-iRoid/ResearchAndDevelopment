...
class SocketHelper(
    ...
    companion object {
        ...
        const val END_POINT = "wss://157.245.106.111:3322"
        const val TOKEN = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MiwiZW1haWwiOiJkZWVwYWtAeW9wbWFpbC5jb20iLCJuYW1lIjoiRGVlcGFrIiwiaWF0IjoxNzU5ODE1NTAwLCJleHAiOjE3NjA0MjAzMDB9._cq-JHeDuwnt-MlmSUSmLHu7GejVzy5ly34wJi9-lJk"
    }
}